...
public:
    ...
    public:
        ...
        Node() : m_input_count(0), m_max_thread_number(0), m_bRelease_thread(false)
        {
            m_cb_func = nullptr;
        }
    
        Node(callback_type func) : m_cb_func(func), m_input_count(0), m_max_thread_number(0), m_bRelease_thread(false)
        {
        }
